...
$( document ).ready(function() {
  ...
  $('#filtro-partidos').on('change', function (e) {
    ...
    selectOptionPart(partidoSelected, valueSelected)
  });
...
const loadBarGraphics =  (datosBar, entidad) => {
  ...
  const et = g
    ...
    .text(yAccessor)
    .text(function(d) { return f(d.votos); })
  ...
  arrLogos = [
    ...
    "img/logo_morena.jpg",
    "img/logo_pmc.jpg",
    "img/logo_co_pan_pri_prd.png",
    "img/logo_co_pan_pri.png",
    "img/logo_co_pan_prd.png",
    "img/logo_co_pri_prd.png",
    "img/logo_co_pvem_pt.png",
  ] 
  let anchoImg = 10;
  $.each( arrLogos, function( key, val ) {
    ...
    const titulo = g
      ...
      .attr("y", - 25)
      .classed("titulo", true)
      .text(`Votos emitidos por Partido Politico para el Distrito: ${entidad}`)
  // Ejes
